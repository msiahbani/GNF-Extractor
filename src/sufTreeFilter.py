...
if __name__ == "__main__":
    ...
    optparser.add_option("", "--sentfile", dest="sentfile", default=None, help="data file for filtering (default=None)")
    optparser.add_option("", "--sentdir", dest="sentdir", default="sent", help="directory of filter files (default=sent)")
    optparser.add_option("-r", "--rulefile", dest="rulefile", default=None, help="rule file (default=None)")
    optparser.add_option("", "--outfile", dest="filterfile", default="rules_cnt.final.out", help="filtered directory (default=rules_cnt.final.out)")
    optparser.add_option("", "--outdir", dest="filterdir", default="rules", help="filtered directory (default=rules)")
